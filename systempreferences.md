...
_The following commands can be run as each or create a new file `.macos` and paste the commands in and run the file as an executable._
...
defaults write NSGlobalDomain AppleLocale -string "en_AU@currency=NZD"
...
Special thanks to `mathiasbynens` for their original list of commands https://github.com/mathiasbynens/dotfiles/blob/main/.macos
